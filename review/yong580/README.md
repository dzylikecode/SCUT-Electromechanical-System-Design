...
11. 光栅（莫尔条纹原理及计算）、光电编码器、直流测速机的原理；感应同步器（鉴相式和鉴幅式）原理的证明。**(难点)**
    ...
    - 光栅 PPT P43
      ...
      <img class="Pages" class="Pages" src="assets/2023-02-19-15-42-46-7b97e8636b491fe702399779b3f6e64.png" title="" alt="" width="464">

      <img class="Pages" src="assets/2023-02-19-15-43-02-image.png" title="" alt="" width="250">
    ...
    <img class="Pages" src="assets/2023-02-15-09-13-07-image.png" title="" alt="" width="265">
